...
- (void)configCustomNaviBar {
    ...
    UIView *maskInnerStatusBar =
    [[UIView alloc] initWithFrame:maskStatusBar.bounds];
    maskInnerStatusBar.backgroundColor = _naviBar.backgroundColor;
    [maskStatusBar addSubview:maskInnerStatusBar];
